...
function Hero({ hero }: { hero: HeroTypes[] }) {
  return (
    <div className="relative w-full pt-36 pb-36 flex flex-col justify-center items-center text-white">
            ...
            >
              {item.buttonText.map((buttonText: ButtonText) => (
                <a
                  ...
                  className="relative px-8 py-3 text-lg font-medium text-white border-2 border-white rounded-none overflow-hidden transition-all duration-300 group"
                >
